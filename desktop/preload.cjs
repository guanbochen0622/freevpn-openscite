...
const methods=Object.fromEntries(['providerStatus','providerSet','providerModels','providerAsk','status','login','logout','models','ask','cancel'].map(method=>[method,(params)=>ipcRenderer.invoke('openscite:'+method,params)]));
