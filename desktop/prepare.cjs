...
for(const name of ['ai-handoff.js','ai-providers.js','ai-connections.js','reader-layout.js','index.html','app.js','pdf-text.js','document-core.js','document-understanding.js','boot.js','workspace.js','reader-tools.js','reader-core.js','reader-experience.js','workspace.css','styles.css','i18n.js','locales','vendor'])fs.cpSync(path.join(root,name),path.join(dest,name),{recursive:true});
