...
for(const name of ['index.html','app.js','pdf-text.js','document-core.js','document-understanding.js','boot.js','workspace.js','reader-tools.js','workspace.css','styles.css','i18n.js','locales','vendor'])fs.cpSync(path.join(root,name),path.join(dest,name),{recursive:true});
