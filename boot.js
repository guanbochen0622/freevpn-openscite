try{await import('./i18n.js?v=25.5.0');}catch(e){console.error('Language setup failed',e);}
// Keep search and the library usable even if the PDF engine cannot initialize.
const ASSET_VERSION = '25.5.0';
try {
...
for (const src of [`pdf-text.js?v=${ASSET_VERSION}`, `app.js?v=${ASSET_VERSION}`, `workspace.js?v=${ASSET_VERSION}`, `reader-tools.js?v=${ASSET_VERSION}`]) {
  try {
