...
const ctx={PdfText:require('../pdf-text.js'),setTimeout,state:{reader:{renderToken:7,pageTexts:[],pdf:{numPages:3,async getPage(n){return {async getTextContent(){if(n===2)throw Error('Test font failure');return {items:[{str:'Page '+n}]}}}}}}},$:()=>({textContent:''})};
